<template>
  <div class="Intranet">
    ...
    <div class="title" v-if="this.status == 'admin'">
      <p> <i class="fa-solid fa-user-tie"></i> DEPARTEMENT <span class="spn">ADMINISTRATIVE</span> </p>
    </div>
      ...
      <div @click="gestionRH()">
        ...
        <a href="#" class="card human-resources">
          ...
          <div class="circle">
            ...
            <img src="./../assets/da/user-svgrepo-com.svg" alt="">
      ...
      <div @click="gestionCalendrier()" v-if="status != 'inspecteur'">
        ...
        <a href="#" class="card human-resources">
          ...
          <div class="circle">
            ...
            <img src="./../assets/da/calendar-svgrepo-com (1).svg" alt="">
      ...
      <div @click="analyseStatistique()" v-if="status != 'inspecteur'">
        ...
        <a href="#" class="card human-resources">
          ...
          <div class="circle">
            ...
            <img src="./../assets/da/stats-svgrepo-com.svg" alt="">
...
export default {
  ...
  methods: {
    ...
    gestionFournisseur() {
      return this.$router.push("/fournisseur");
    },

    gestionRH() {
      return this.$router.push("/gestionrh");
    },
