<template>
  <div class="Intranet">
    ...
    <div class="parent">
          ...
          <div @click="agrements()" v-if="status != 'inspecteur'">
            <a href="#" class="card human-resources">
          <div class="overlay"></div>
          <div class="circle">

            <img src="./../assets/dq/aggrement.svg" alt="">
          ...
          <div class="circle">
            ...
            <img src="./../assets/dq/mate.svg" alt="">
          ...
          <div class="circle">
            ...
            <img src="./../assets/dq/etalo.svg" alt="">
...
export default {
  ...
  methods : {
    ...
    agrements() {
      return this.$router.push("/agrement");
    },
