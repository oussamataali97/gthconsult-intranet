<template>
    <div class="gestionInspecteur"  >
      ...
      <h3 v-if="flagInsertIntervention == false">EN ATTENTE PRODUCTION</h3>
      <div v-if="flagInsertIntervention == false" class="rechercher-table">
            ...
            <table id="inspecteurs">
              ...
              <tr v-for="(affaire, i) in filterAffaires" :key="affaire._id">
                ...
                <td v-if="affaire.bonCommande == 'false'" @click="bonCommande(affaire._id)" style="background-color: white; margin : 0; padding: 0; padding-bottom: 5px; padding-left: 5px;"><p style="font-size: 20px; color:red; font-wight: bold; font-weight: bold;">AP</p><i class="fa-solid fa-forward-step" style="font-size: 20px; color:red;"></i></td>
                ...
                <td v-if="affaire.importRapport == 'false'" style="background-color: white; margin : 0; padding: 0; padding-bottom: 5px; padding-left: 5px;"><p style="font-size: 20px; color:red; font-wight: bold; font-weight: bold;">RE</p><i class="fa-solid fa-forward-step" style="font-size: 20px; color:white;"></i></td>
      ...
      <ul class="pagination" v-if="flagInsertIntervention == false">
      ...
      <!--  Start Info Client   -->
        <InsertIntervention :affaireId="affaireId" v-if="flagInsertIntervention == true" />
      <!--  End Info Client   -->
...
import InsertIntervention from "../Affaire/InsertIntervention.vue";
...
export default {
  ...
  // Delte Bon Cammande
  deleteBonCammande(affaireId, index) {

    Service.DeleteBonCammande(affaireId)
    .then((result) => {
        if(result) {
