<template>
  <div class="creationClient">
    ...
    <h3>CRÉATION CHARGE EN EXPLOITATION</h3>
    ...
    <div class="formCreation">
      ...
      <div>
        <input type="submit" value="Créer la charge d'exploitation" @click="create()">
      </div>
...
export default {
  ...
  methods: {
    ...
    create() {
        ...
        this.msgCharge = "Veuillez patienter quelques secondes pour enregister";

        Service.createChargeExploitation(this.charge, this.file)
          .then((result) => {
              if(result) {
                  setTimeout(() => {
