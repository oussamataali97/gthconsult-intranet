<template>
  <div class="creationClient">
    ...
    <h3><i class="fa-solid fa-file-circle-plus"></i> CRÉER FICHE TECHNIQUE MATÉRIEL</h3>
    ...
    <div class="formCreation">
      ...
      <div>
        <input type="submit" value="Créer un fiche" @click="create()">
      </div>
...
export default {
  ...
  methods: {
    ...
    // create Etalonnage
    create() {
      Service.createFicheTechnique(this.ficheTechnique, this.file)
      .then((response) => {
          this.traitement = true;
          this.msgFicheTechnique = "Veuillez patienter quelques secondes pour enregistre la fiche technique";
          if(response) {
              setTimeout(() => {
